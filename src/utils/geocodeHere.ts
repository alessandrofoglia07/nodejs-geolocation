 ...
 */
export const geocodeHere = async (address: string, apiKey: string, appID: string): Promise<unknown> => {
 ...
 */
export const reverseGeocodeHere = async (lat: number, lon: number, apiKey: string, appID: string): Promise<unknown> => {
